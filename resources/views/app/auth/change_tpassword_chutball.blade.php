...
<head>
    ...
    <title>Senha de Saque | CHUTBALL</title>
...
<body>
    <div class="shell">
        <section class="hero">
            ...
            <div class="brand-row">
                ...
                <div class="brand-meta">
                    <small>Seguranca de saque</small>
                    <h1>CHUTBALL</h1>
                    <p>Defina uma senha de retirada para proteger operacoes de saque e alteracoes sensiveis.</p>
                </div>
            </div>
        </section>
        ...
        <form action="{{ route('user.change.tpassword.confirmation') }}" method="post" class="card">
            @csrf
            <div class="tabs">
                <a href="{{ route('user.change.tpassword') }}" class="active">Senha de saque</a>
                <a href="{{ route('user.change.password') }}">Senha de login</a>
            </div>

            <div class="field">
                <label>Nova senha de saque</label>
                <div class="input">
                    <i class="fa-solid fa-key"></i>
                    <input type="password" name="new_password" placeholder="Digite a nova senha de saque" required>
                </div>
            </div>
            ...
            <div class="field">
                ...
                <div class="input">
                    ...
                    <input type="password" name="confirm_password" placeholder="Repita a senha de saque" required>
                </div>
            </div>

            <button type="submit" class="submit">Salvar senha de saque</button>
        </form>
    </div>
</body>
</html>
