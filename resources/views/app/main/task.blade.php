...
<head>
 ...
 ==================== */
    ...
    <style type="text/css">.content[data-v-38ad054e] {
            height: 100vh;
            /* overflow-y: scroll; */
            position: relative;
            background: url({{asset('public')}}/static/public/loginbg1.jpg);
            background-size: 100% 100%
        }

        .contentview[data-v-38ad054e] {
            position: absolute;
            top: 0;
            width: 100%;
            height: 100vh;
        ...
        .wrap-body[data-v-38ad054e] {
            width: 95%;
            /* min-height: 800upx; */
            /* height: 70%; */
            background: url({{asset('public')}}/static/public/logininputbg.png) no-repeat top/100% 100%
        }

        .wrap-body .title[data-v-38ad054e] {
            display: flex;
            align-items: center;
            justify-content: center;
            height: 30px;
        ...
        .webtitle[data-v-38ad054e] {
            align-items: center
        }

        .webtitle uni-image[data-v-38ad054e] {
            width: 30px;
            height: 30px;
            border: 1px solid #ff5b00;
            border-radius: 100%
        ...
        .titles[data-v-38ad054e] {
            font-size: 19px
        }

        .text-777[data-v-38ad054e] {
            color: #666;
            font-size: 12px
        }

        .input-item .title1[data-v-38ad054e] {
            display: flex;
            align-items: center
        }

        .input-item .title1 > uni-view[data-v-38ad054e] {
            box-sizing: border-box;
            font-weight: 400;
            color: #666;
            margin-left: 5px;
        ...
        .input-item uni-image[data-v-38ad054e] {
            width: 18px;
            height: 18px
        }

        .inputtxt[data-v-38ad054e] {
            align-items: center;
        ...
        .arescode[data-v-38ad054e] {
            color: #000;
            font-size: 15px;
            font-weight: 800
        }

        .text-666[data-v-38ad054e] {
            color: #666
        }

        .inputactive .uni-input-placeholder[data-v-38ad054e],
        .inputactive .uni-input[data-v-38ad054e] {
            position: absolute;
            top: auto !important;
            left: 0;
        ...
        .inputactive .inputtxt[data-v-38ad054e] {
            border: 1px solid #ffa900 !important
        }

        .loginbtn[data-v-38ad054e] {
            background: #ff5b00;
        ...
        .loginbtn uni-image[data-v-38ad054e] {
            width: 20px;
            height: 20px;
            margin-left: 5px
        }

        .text11[data-v-38ad054e] {
            display: flex;
            align-items: center;
            font-size: 12px
        }

        .text11 .poiner[data-v-38ad054e] {
            width: 22px;
            margin-left: 1px;
            height: 22px
        }

        .telegram[data-v-38ad054e] {
            width: 60px !important;
            margin-left: -6px !important;
            height: 60px !important
        }

        .input-item uni-input[data-v-38ad054e] {
            font-size: 14px;
            color: #000
        }

        .inputpwd[data-v-38ad054e] {
            font-size: 14px;
            border: none !important;
            outline: none !important
        }

        .codeimg[data-v-38ad054e] {
            margin: -7px 0;
    ...
    <style type="text/css">.content[data-v-bcec88f8] {
            height: 100vh;
            /* overflow-y: scroll; */
            position: relative;
            background: url({{asset('public')}}/static/public/loginbg1.jpg);
        ...
        .wrap-body .title[data-v-bcec88f8] {
            display: flex;
            align-items: center;
            justify-content: center;
            width: 110px;
        ...
        .webtitle[data-v-bcec88f8] {
            align-items: center;
            margin-bottom: 5px
        }

        .webtitle uni-image[data-v-bcec88f8] {
            width: 30px;
            height: 30px;
            /* border: 1px solid #ff5b00; */
            border-radius: 100%
        ...
        .titles[data-v-bcec88f8] {
            font-size: 19px
        }

        .text-777[data-v-bcec88f8] {
            color: #666;
            font-size: 12px
        }

        .input-item .title1[data-v-bcec88f8] {
            display: flex;
            align-items: center
        }

        .input-item .title1 > uni-view[data-v-bcec88f8] {
            box-sizing: border-box;
            font-weight: 400;
            color: #666;
            margin-left: 5px;
        ...
        .input-item uni-image[data-v-bcec88f8] {
            width: 18px;
            height: 18px
        }

        .inputtxt[data-v-bcec88f8] {
            align-items: center;
            border: 1px solid #999;
            border-radius: 25px;
            color: #ffa900;
        ...
        .arescode[data-v-bcec88f8] {
            color: #000;
            font-size: 15px;
            font-weight: 800
        }

        .text-666[data-v-bcec88f8] {
            color: #666
        }

        .inputactive .uni-input-placeholder[data-v-bcec88f8],
        .inputactive .uni-input[data-v-bcec88f8] {
            position: absolute;
            top: auto !important;
            left: 0;
            color: #ffa900 !important;
        ...
        .inputactive .inputtxt[data-v-bcec88f8] {
            border: 1px solid #ffa900 !important
        }

        .loginbtn[data-v-bcec88f8] {
            background: #ff5b00;
            border-radius: 4.4rem;
            color: #fff;
            font-size: 17px;
        ...
        .loginbtn uni-image[data-v-bcec88f8] {
            width: 20px;
            height: 20px;
            margin-left: 5px
        }

        .text11[data-v-bcec88f8] {
            display: flex;
            align-items: center;
            font-size: 12px
        }

        .text11 .poiner[data-v-bcec88f8] {
            width: 22px;
            margin-left: 1px;
            height: 22px
        }

        .telegram[data-v-bcec88f8] {
            width: 60px !important;
            margin-left: -6px !important;
            height: 60px !important
        }

        .input-item uni-input[data-v-bcec88f8] {
            font-size: 14px;
            color: #000
        }

        .inputpwd[data-v-bcec88f8] {
            font-size: 14px;
            border: none !important;
            outline: none !important
        }</style>
    ...
    <style type="text/css">.floor[data-v-201873ac] {
            ...
            z-index: 999999999;
            background: #fff;
            box-shadow: 0 1px 5px rgba(36, 97, 231, .2);
    ...
    <style type="text/css">.mask[data-v-678f9fab] {
            position: fixed;
            z-index: 99;
            width: 85%;
            left: 2%;
        ...
        .time_box[data-v-678f9fab] {
            background-color: #e1e6e1
        }

        .content[data-v-678f9fab] {
            display: flex;
            flex-direction: column;
            align-items: center;
            justify-content: center
        ...
        .top[data-v-678f9fab] {
            background: url({{asset('public')}}/static/index/home.png);
            height: 150px;
            width: 100%;
            background-repeat: no-repeat;
            background-size: 100% 100%
        ...
        .indeximg[data-v-678f9fab] {
            width: 35px;
            height: 35px
        }

        .indexbox[data-v-678f9fab] {
            /* background-color: #fff; */
            /* border-radius: 20px; */
            align-items: center;
            justify-content: space-between;
        ...
        .indexbox > uni-view[data-v-678f9fab] {
            border-bottom: 1px solid #353861
        }

        .indexbox > uni-view[data-v-678f9fab]:nth-child(1),
        .indexbox > uni-view[data-v-678f9fab]:nth-child(2),
        .indexbox > uni-view[data-v-678f9fab]:nth-child(3) {
            border-right: 1px solid #353861
        }

        .indexboxtext[data-v-678f9fab] {
            font-size: 17px;
            padding-left: 10px;
            color: #222;
            font-style: italic;
        ...
        .line[data-v-678f9fab] {
            width: 4px;
            height: 20px;
            /* background-color: rgb(231, 183, 36); */
            /* background-color: #b83b20; */
            background: #a9abfc;
            border-radius: 4px
        }

        .boxbtn[data-v-678f9fab] {
            width: 80%;
            height: 35px;
            line-height: 35px;
            border-radius: 5px;
            ...
            /* line-height: 70upx; */
            /* background-color: rgba(231, 183, 36, 0.8); */
            /* background-color: #b83b20; */
            /* background: linear-gradient(45deg,  #ff6611,#ff2111); */
        }

        .linetext[data-v-678f9fab] {
            font-size: 16px;
            padding-left: 10px;
            /* color: #000; */
            font-weight: 600
        ...
        .line_content[data-v-678f9fab] {
            font-size: 12px;
            /* color: #222; */
            padding: 10px 0
        }

        .bigbox[data-v-678f9fab] {
            position: relative;
            border-radius: 5px;
            overflow: hidden;
            background: #1b1c32;
        ...
        .bigtop[data-v-678f9fab] {
            height: 20px;
            display: none;
            /* background-image: url(@/{{asset('public')}}/static/index/rental-headred.png); */
            width: 100%;
            background-size: 100% 100%;
        ...
        .bg-img[data-v-678f9fab] {
            background-image: url({{asset('public')}}/static/index/head.png);
            background-size: 100% 100%;
            height: 100px
        }

        .text[data-v-678f9fab] {
            font-size: 12px;
            color: #222
        }

        .closebtn[data-v-678f9fab] {
            background: linear-gradient(270deg, #ffa900, #ff5b00);
            border-radius: 4.4rem;
            font-family: Tinos;
            line-height: 30px;
            font-weight: 700;
        ...
        .noticebg[data-v-678f9fab] {
            width: 100% !important;
            padding: 90px 20px 0 20px;
            background: url({{asset('public')}}/static/index/ic_bg.png) no-repeat top/100% 100%
        }

        .toptitle[data-v-678f9fab] {
            align-items: center;
            font-size: 19px;
            color: #fff
        }

        .toptitle uni-image[data-v-678f9fab] {
            width: 30px;
            height: 30px
            /* border: 1px solid #ff5b00; */
            /* background: white; */
        ...
        .noticeimg[data-v-678f9fab] {
            width: 26.5px;
            height: 26.5px
        }

        .descrbe[data-v-678f9fab] {
            width: 90%;
            font-size: 13px;
            margin-top: 10px;
            color: #fff;
        ...
        .aboutbtn uni-image[data-v-678f9fab] {
            width: 10px;
            height: 10px;
            margin-left: 5px
        }

        .aboutbtn[data-v-678f9fab] {
            padding: 2px 10px;
            background: #fff;
        ...
        .setting[data-v-678f9fab] {
            background: url({{asset('public')}}/static/index/settingbg.png) top/100% 100%
        }

        .tabtitle > uni-view[data-v-678f9fab] {
            width: 45%;
            text-align: center;
        ...
        .balancebox[data-v-678f9fab] {
            border-radius: 5px;
            background: #fff
        }

        .balancebox .txt[data-v-678f9fab] {
            font-weight: 400;
            font-size: 11px;
            color: #666
        }

        .balancebox .price[data-v-678f9fab] {
            font-weight: 600;
            font-size: 14px
        }

        .tabright uni-image[data-v-678f9fab] {
            margin-bottom: 2px;
            width: 35.3px;
            height: 35.3px
        }

        .tabright[data-v-678f9fab] {
            display: flex;
            flex-direction: column;
            justify-content: center;
            font-weight: 400;
        ...
        .signbox[data-v-678f9fab] {
            background: url({{asset('public')}}/static/index/signbg.png) top/100% 100%
        }

        .nosignbtn[data-v-678f9fab] {
            padding: 5px 20px;
            color: #000;
            opacity: .5;
            background: url({{asset('public')}}/static/index/nosignbtn.png) top/100% 100%
        }

        .signbtn[data-v-678f9fab] {
            padding: 7px 20px;
            color: #fff;
            font-size: 16px;
            background: linear-gradient(180deg, #ffa900, #ff5b00);
        ...
        .taskbox[data-v-678f9fab] {
            display: flex;
            justify-content: space-between;
            text-align: center
        }

        .taskbox1[data-v-678f9fab] {
            width: 46%;
            color: #ff5b00;
            padding: 10px 0;
            background: url({{asset('public')}}/static/index/task1.png) top/100% 100%
        }

        .taskbox2[data-v-678f9fab] {
            width: 46%;
            padding: 10px 0;
            color: #666;
            background: url({{asset('public')}}/static/index/task2.png) top/100% 100%
        }

        .tasktitle[data-v-678f9fab] {
            width: 100%%;
            padding: 7px 0;
            color: #fff;
            background: url({{asset('public')}}/static/index/tasktitle.png) top/100% 100%
        }

        .inviteboxlist[data-v-678f9fab] {
            color: #000;
            background: #fff;
            border-radius: 10px !important
        }

        .inviteboxlist > uni-view[data-v-678f9fab] {
            border-bottom: 1px rgba(0, 0, 0, .3137254901960784) solid
        }

        .inviteboxlist uni-image[data-v-678f9fab] {
            width: 80px;
            height: 80px;
            border-radius: 5px
        }

        .text-glod[data-v-678f9fab] {
            color: #ff7600
        }
	...
	position: relative;
        ...
        .flexbox > uni-view[data-v-678f9fab] {
            position: relative
        }

        .flexbox > uni-view[data-v-678f9fab]:nth-child(1)::after {
            position: absolute;
            height: 50%;
            top: 50%;
            ...
            content: " ";
            width: 2px;
            background: rgba(77, 77, 77, .3764705882352941);
            border-radius: 2px
        }

        .flexbox > uni-view[data-v-678f9fab]:nth-child(2)::after {
            position: absolute;
            height: 50%;
            top: 50%;
            -webkit-transform: translateY(-50%);
    ...
    <style type="text/css">.barhead[data-v-75c2b891] {
            ...
            font-size: 15px;
            font-weight: 500;
            background-image: url({{asset('public')}}/static/invite/barred2.png);
            background-size: 100% 100%
        }
        ...
        .content[data-v-75c2b891] {
            min-height: 100%
            /* background-color: #b83b20; */
        }

        .radius[data-v-75c2b891] {
            border-radius: 5px
        }

        .headbox[data-v-75c2b891] {
            margin: 0px 20px 0px 20px;
            padding: 15px;
            border-radius: 5px;
            /* background: white; */
            color: #fff;
            background: linear-gradient(180deg, rgba(255, 169, 0, .5647058823529412), #ff5b00)
        }

        .headbox1[data-v-75c2b891] {
            margin: 0px 20px 0px 20px;
        ...
        .headmiddle-box[data-v-75c2b891] {
            flex: 1;
            text-align: center
        }

        .middle[data-v-75c2b891] {
            height: 50px;
            width: 1px;
        ...
        .tablebox[data-v-75c2b891] {
            padding: 10px 17px 15px 17px
        }

        .tablebox1[data-v-75c2b891] {
            padding: 0px 17px 15px 17px;
            margin-top: -10px
        }

        .historybox[data-v-75c2b891] {
        ...
        .teambox > uni-view[data-v-75c2b891] {
            margin-top: 10px
        }
        ...
        .historytabs[data-v-75c2b891] {
            display: flex;
            justify-content: space-between
        }

        /* .historytabs .tab:nth-child(1) {
	margin-right: 15upx;
} */
        .tab[data-v-75c2b891] {
            width: 49%;
        ...
        .historytabs .active[data-v-75c2b891] {
            color: #fff !important;
            background: #161730 !important;
            border: 1px solid #ffa900 !important
        }

        table[data-v-75c2b891] {
            border-radius: 10px;
            overflow: hidden;
            width: 100%;
            padding: 0;
        ...
        tr[data-v-75c2b891]:nth-child(1) {
            color: #111;
            font-weight: 500;
            font-size: 14px;
        ...
        .activity1[data-v-75c2b891] {
            /* color: #b83b20; */
            background: linear-gradient(90deg, rgba(255, 169, 0, .5647058823529412), #ff5b00);
            /* background: linear-gradient(90deg, rgba(0, 0, 0, 0), #ffa900); */
            border-radius: 0 25px 25px 0
        }</style>
</head>
<body class="uni-body pages-invitation-invitation">
<uni-app class="uni-app--maxwidth">
    <uni-page>
        <uni-page-wrapper>
            <uni-page-body>
                <uni-view data-v-75c2b891="" class="content">
                    <uni-view data-v-75c2b891="" class=" padding padding-top-xl text-xl text-white flex"
                              style="font-size: 20px; font-weight: 800; position: relative; width: 100%; top: 0px; height: 45px;">
                        <uni-view data-v-75c2b891="" class="flex-sub"></uni-view>
                        <uni-view data-v-75c2b891="" class="text-center"
                                  style="width: 80%; font-size: 20px; font-weight: 800;"></uni-view>
                        <uni-view data-v-75c2b891="" class="text-right" style="flex: 1 1 0%;"></uni-view>
                    </uni-view>
                    <uni-view data-v-75c2b891="" class="headtop" style="margin-top: -45px;">
                        <uni-view data-v-75c2b891="" class="text-xl padding-top padding-left-sm text-black text-bold">
                            Promotion
                        </uni-view>
                    </uni-view>
                    <uni-view data-v-75c2b891="" class="headbox">
                        <uni-view data-v-75c2b891="">Invitation link</uni-view>
                        <uni-view data-v-75c2b891="" class="margin-top flex radius box">
                            <uni-view data-v-75c2b891="" class="padding text-cut" style="flex: 1 1 0%;">
                                https://bpip.shop/#/pages/public/reg?invter=Z783369262
                            </uni-view>
                            <uni-view data-v-75c2b891="" class="radius padding-sm margin-xs copybtn">copy</uni-view>
                        </uni-view>
                    </uni-view>
                    <uni-view data-v-75c2b891="" class="tablebox">
                        <uni-view data-v-75c2b891="" class="text-bold padding-xs">BPIP is the most supported platform in
                            Ghana. Users who already know how to make money through BPIP can
                            get rewards through invitations. You will get 25% reward for level 1 subordinates, 3% reward
                            for level 2
                            subordinates, and 2% reward for level 3 subordinates.
                        </uni-view>
                        <uni-view data-v-75c2b891="" class="text-xl" style="font-weight: 500; position: relative;">
                            <uni-view data-v-75c2b891="" class="flex padding-tb-sm"
                                      style="position: relative; z-index: 50;">
                                <uni-view data-v-75c2b891="" class="flex padding-xs padding-right activity1">
                                    <uni-image data-v-75c2b891="" style="width: 35px; height: 35px;">
                                        <div style="background-image: url(data:image/png;base64,); background-position: 0% 0%; background-size: 100% 100%; background-repeat: no-repeat;"></div>
                                        <img
                                            src="data:image/png;base64,"
                                            draggable="false"></uni-image>
                                    <uni-view data-v-75c2b891="" class="padding-left text-white"
                                              style="line-height: 35px;">Daily
                                    </uni-view>
                                </uni-view>
                            </uni-view>
                            <table data-v-75c2b891="">
                                <tr data-v-75c2b891="">
                                    <td data-v-75c2b891="">investment amount</td>
                                    <td data-v-75c2b891="">Level1 Rewards</td>
                                    <td data-v-75c2b891="">Level2 Rewards</td>
                                    <td data-v-75c2b891="">Level3 Rewards</td>
                                </tr>
                                <uni-view data-v-75c2b891="">
                                    <tr data-v-75c2b891="" style="background: none; font-weight: 600;">
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">360</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">90</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">10.8</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">7.2</uni-view>
                                        </td>
                                    </tr>
                                    <tr data-v-75c2b891="" style="background: none; font-weight: 600;">
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">950</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">237.5</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">28.5</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">19</uni-view>
                                        </td>
                                    </tr>
                                    <tr data-v-75c2b891="" style="background: none; font-weight: 600;">
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">2000</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">500</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">60</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">40</uni-view>
                                        </td>
                                    </tr>
                                    <tr data-v-75c2b891="" style="background: none; font-weight: 600;">
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">3980</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">995</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">119.4</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">79.6</uni-view>
                                        </td>
                                    </tr>
                                    <tr data-v-75c2b891="" style="background: none; font-weight: 600;">
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">8000</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">2000</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">240</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">160</uni-view>
                                        </td>
                                    </tr>
                                    <tr data-v-75c2b891="" style="background: none; font-weight: 600;">
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">22000</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">5500</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">660</uni-view>
                                        </td>
                                        <td data-v-75c2b891="">
                                            <uni-view data-v-75c2b891="" class="padding-xs">440</uni-view>
                                        </td>
                                    </tr>
                                </uni-view>
                            </table>
                                ...
                                <uni-view data-v-75c2b891="" class="flex padding-xs padding-right activity1">
                                    <uni-image data-v-75c2b891="" style="width: 35px; height: 35px;">
                                        ...
                                        <img
                                            ...
                                            draggable="false"></uni-image>
                                    <uni-view data-v-75c2b891="" class="padding-left text-white"
                                              style="line-height: 35px;">Long-term
                                    </uni-view>
                                </uni-view>
                            </uni-view>
                        </uni-view>
                        <table data-v-75c2b891="">
                            ...
                            <uni-view data-v-75c2b891="">
                                <tr data-v-75c2b891="" style="background: none; font-weight: 600;">
                                    ...
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">125</uni-view>
                                    </td>
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">15</uni-view>
                                    </td>
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">10</uni-view>
                                    </td>
                                </tr>
                                <tr data-v-75c2b891="" style="background: none; font-weight: 600;">
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">1300</uni-view>
                                    </td>
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">325</uni-view>
                                    </td>
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">39</uni-view>
                                    </td>
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">26</uni-view>
                                    </td>
                                </tr>
                                <tr data-v-75c2b891="" style="background: none; font-weight: 600;">
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">3300</uni-view>
                                    </td>
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">825</uni-view>
                                    </td>
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">99</uni-view>
                                    </td>
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">66</uni-view>
                                    </td>
                                </tr>
                                <tr data-v-75c2b891="" style="background: none; font-weight: 600;">
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">8200</uni-view>
                                    </td>
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">2050</uni-view>
                                    </td>
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">246</uni-view>
                                    </td>
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">164</uni-view>
                                    </td>
                                </tr>
                                <tr data-v-75c2b891="" style="background: none; font-weight: 600;">
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">17000</uni-view>
                                    </td>
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">4250</uni-view>
                                    </td>
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">510</uni-view>
                                    </td>
                                    <td data-v-75c2b891="">
                                        <uni-view data-v-75c2b891="" class="padding-xs">340</uni-view>
                                    </td>
                                </tr>
                            </uni-view>
                        </table>
