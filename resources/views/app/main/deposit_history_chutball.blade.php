...
<head>
    ...
    <title>Historico de Depositos | CHUTBALL</title>
...
<body>
    ...
    <div class="list">
        ...
        @empty
            <div class="card"><strong>Nenhum deposito encontrado.</strong></div>
        @endforelse
    </div>
</body>
</html>
