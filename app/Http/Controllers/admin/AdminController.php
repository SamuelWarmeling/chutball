                ...
                if ($package) {
                    if (now()->greaterThanOrEqualTo($purchase->date)) {
                        ...
                        if ($first_ref){
                            ...
                            $ledger->perticulation = 'Received first interest commission';
                            ...
                            if ($second_ref){
                                ...
                                $ledger->get_balance_from_user_id = $user->id;
                                $ledger->reason = 'commission';
                                $ledger->perticulation = 'Received second interest commission';
                                $ledger->amount = $amount;
                                $ledger->debit = $amount;
                                $ledger->status = 'approved';
                                $ledger->step = 'second';
                                ...
                                if ($third_ref){
                                    ...
                                    $ledger->get_balance_from_user_id = $user->id;
                                    $ledger->reason = 'commission';
                                    $ledger->perticulation = 'Received third interest commission';
                                    $ledger->amount = $amount;
                                    $ledger->debit = $amount;
                                    $ledger->status = 'approved';
                                    $ledger->step = 'third';
